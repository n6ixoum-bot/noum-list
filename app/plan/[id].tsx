...
const styles = StyleSheet.create({
  ...
  completedCard: { backgroundColor: "#0B2416", borderColor: "#245E3C" },
  taskMain: { flexDirection: "row", alignItems: "flex-start", gap: 11 },
  check: { width: 25, height: 25, borderRadius: 13, borderWidth: 2, borderColor: "#53655A", alignItems: "center", justifyContent: "center", marginTop: 2 },
  ...
  sourceButton: { flexDirection: "row", alignItems: "center", gap: 5, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 7, backgroundColor: BRAND.background },
