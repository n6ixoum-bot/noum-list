...
const styles = StyleSheet.create({
  ...
  flashcardButton: { minHeight: 62, paddingHorizontal: 14, borderRadius: 17, backgroundColor: BRAND.primary, flexDirection: "row", alignItems: "center", gap: 9, marginTop: 14 },
  flashcardCopy: { flex: 1 },
  flashcardTitle: { color: "#07160D", fontSize: 14, fontWeight: "900", textAlign: "right" },
  flashcardText: { color: "#123B23", fontSize: 11, textAlign: "right", marginTop: 2 },
